...
# 2-2. Simple Message: Assign a message to a variable, and then print that message. 
...
# Print the name once, so the whitespace around the name is displayed. Then print the name using each of the three stripping functions, Istrip(), rstrip(), and strip().
...
# add at least one comment to each. If you don't have anything specific to write because your programs are too simple at this point, just add your name and the current date at the top of each program file. Then write one sentence describing what the program does.

# 2-12. Zen of Python: Enter import this into a Python terminal session and skim through the additional principles.

person_name = "Hola"
# Esto imprime "Hola" sin salto de línea al final
print(person_name, end="") 
# La siguiente línea se imprime inmediatamente después, en la misma línea
print("Mundo")

person_name = "Hola"
# Esto imprime "Hola" con salto de línea al final
print(person_name) 
# Esto imprime "Mundo" con salto de línea al final
print("Mundo")